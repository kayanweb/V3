              ...
              <form onSubmit={handleEmailLogin} className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button type="button" onClick={() => router.push('/forgot-password')} className="text-xs text-teal-600 hover:underline">{isAr ? 'نسيت كلمة السر؟' : 'Forgot password?'}</button>
                  </div>
                  <div className="relative">
                    <Lock className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground" />
                ...
                <div className="text-center text-sm">
                  ...
                  <button type="button" onClick={() => router.push('/signup')} className="text-teal-600 hover:underline font-medium inline-flex items-center gap-1">
